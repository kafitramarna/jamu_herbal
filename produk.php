...
// Ambil semua produk dan ambil varian pertamanya untuk ditampilkan
    ...
    <div class="container mt-4 mb-5">
        <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-4">
            <?php foreach ($products as $product) :
                $variant = query("SELECT * FROM product_variants WHERE product_id = {$product['id']} ORDER BY id ASC LIMIT 1");
